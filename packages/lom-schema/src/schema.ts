...
export const query_contract: QueryContract = {
    ...
    write: {
        ...
        create_patterns: [
            ...
            "MATCH (:Device)-[:HAS_CHAIN]->(ch:Chain) CREATE (ch)-[:HAS_DEVICE]->(d:Device {name, index?})",
...
export const LOM_SCHEMA: LomSchema = {
    ...
    relationships: [
        ...
        { type: "HAS_DEVICE", from: "Chain", to: "Device", array: true },
...
export const EXAMPLE_QUERIES: string[] = [
    ...
    'MATCH (t:MidiTrack {name:"New"}) CREATE (t)-[:HAS_DEVICE]->(d:Device {name:"Wavetable"})',
