    ...
    nodes: [
        {
            ...
            properties: [
                ...
                { name: "scaleMode", type: "boolean", access: "rw" },
                { name: "scaleName", type: "string", access: "rw" },
                { name: "rootNote", type: "number", access: "rw", description: "0(C)-11(B)" },
                ...
                { name: "gridIsTriplet", type: "boolean", access: "rw" },
            ],
        },
        {
            label: "Track",
        ...
        },
        {
            ...
            properties: [
                ...
                { name: "loopStart", type: "number", access: "rw" },
                { name: "loopEnd", type: "number", access: "rw" },
                { name: "startMarker", type: "number", access: "rw" },
                { name: "endMarker", type: "number", access: "rw" },
        ...
        },
        {
            ...
            properties: [
                ...
                { name: "name", type: "string", access: "rw" },
                { name: "tempo", type: "number", access: "rw" },
                { name: "signatureNumerator", type: "number", access: "rw" },
                { name: "signatureDenominator", type: "number", access: "rw" },
            ],
        },
        {
            label: "Device",
